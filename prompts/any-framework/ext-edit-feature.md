Edit, update, or enhance an existing Gherkin feature file — works with ANY framework/language.
...
Read the file at [FEATURE_FILE] and understand:
...
- Maintain the existing section comment structure; add new sections only if needed:
  ...
  # ── Non-Functional ───────────────────────────────────
  # ── Accessibility ────────────────────────────────────
- Never remove existing scenarios unless explicitly asked
...
Output:
```
  Feature file updated : [FEATURE_FILE]
  Framework            : [FRAMEWORK]
